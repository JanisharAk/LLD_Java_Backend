package IntroToLLD.constructorsAndStatic;
...
public class FixedDeposit {
    ...
    static void printFDDetails(){
        ...
        //System.out.println("Amount of FD : " + this.amount); -> this wont work, because we call static method using className, so it will never know which object's data to read
